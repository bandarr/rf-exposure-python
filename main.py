...
def main():
    ...
    freq_values = [ FrequencyValues(7.3, 2.25, 1.5), FrequencyValues(14.35, 1.35, 1.5), FrequencyValues(18.1, 3.7, 1.5), FrequencyValues(21.45, 4.45, 1.5), FrequencyValues(24.99, 4.1, 1.5), FrequencyValues(29.7, 2.18, 4.5)]
